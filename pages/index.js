        ...
        <div className="fixed bottom-16 left-0 right-0 z-20 w-full px-6">
          <div className="w-full max-w-md mx-auto">
            <button
              ...
              className="backdrop-blur-lg text-white w-full h-14 rounded-full flex items-center justify-center focus:outline-none font-medium text-lg transition-all duration-200 ease-in-out active:scale-[0.98] hover:scale-[1.01]"
              style={{
