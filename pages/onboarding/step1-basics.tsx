        ...
        <form onSubmit={(e) => { e.preventDefault(); handleNext(); }} className="space-y-5">
          ...
          <div>
             ...
             <div className="space-y-2">
                 {/* Row 1 - Changed to gap-0 */}
                 <div className="flex flex-wrap gap-0 justify-center">{HABITS_ROW_1.map((habit) => (<PillButton key={habit} text={habit} isSelected={selectedHabits.includes(habit)} onClick={() => handleHabitToggle(habit)}/>))}</div>
                 {/* Row 2 - Changed to gap-0 */}
                 <div className="flex flex-wrap gap-0 justify-center">{HABITS_ROW_2.map((habit) => (<PillButton key={habit} text={habit} isSelected={selectedHabits.includes(habit)} onClick={() => handleHabitToggle(habit)}/>))}</div>
                 {/* Row 3 - Changed to gap-0 */}
                 <div className="flex flex-wrap gap-0 justify-center">{HABITS_ROW_3.map((habit) => (<PillButton key={habit} text={habit} isSelected={selectedHabits.includes(habit)} onClick={() => handleHabitToggle(habit)}/>))}</div>
                 {/* Row 4 - Changed to gap-0 */}
                 <div className="flex flex-wrap gap-0 justify-center">{HABITS_ROW_4.map((habit) => (<PillButton key={habit} text={habit} isSelected={selectedHabits.includes(habit)} onClick={() => handleHabitToggle(habit)}/>))}</div>
            </div>
          </div>
