...
const PillButton: React.FC<PillButtonProps> = ({ text, isSelected, onClick, className = '' }) => {
  const baseStyle = "min-h-[44px] inline-flex items-center justify-center px-4 py-2 border rounded-full cursor-pointer transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0A4923] text-base";
