  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-[#14532D] to-[#0A4923] font-['Poppins',sans-serif] text-off-white p-4">
      ...
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        {/* Main Content Card - Reduced padding further to p-1.5 */}
        <main className="w-full max-w-sm bg-off-white/20 backdrop-blur-xl rounded-2xl border border-off-white/15 shadow-xl p-1.5 mt-4">
          {children}
        </main>
      </div>
    </div>
